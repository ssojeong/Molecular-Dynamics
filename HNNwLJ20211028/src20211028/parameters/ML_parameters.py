...
class ML_parameters:
    ...
    def load_dict(json_filename):
        ...
        ML_parameters.sch_reset                 = data['sch_reset']
        ML_parameters.lr_reset                  = data['lr_reset']
        ML_parameters.loss_type                 = data['loss_type']        
        ML_parameters.nepoch                    = data['nepoch']
        ML_parameters.batch_size                = data['batch_size']
        ML_parameters.pw_layer_list             = data['pw_layer_list']
        ML_parameters.f_layer_list              = data['f_layer_list']
