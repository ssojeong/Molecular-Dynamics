...
class pairwise_HNN(HNN_base):
    ...
    def pack_dqdp_tau(self, phase_space, tau_cur):
        ...
        tau_tensor = torch.zeros([nsamples, nparticle, nparticle, 1])
    ...
    def make_dqdp(self, phase_space):
        ...
        l_list = phase_space.get_l_list()
        #print('make dqdp', q_list, p_list)

        dq = phase_space.delta_state_pbc(q_list, l_list)
        # shape is [nsamples, nparticle, nparticle, DIM]

        dp = phase_space.delta_state(p_list)
