...
from fields.derivate_phi_fields_vgrids     import derivate_phi_fields_vgrids
import time
...
class fields_HNN(HNN_base):
    ...
    def __init__(self, fields_MLP1, fields_MLP2, dgrid, ngrid, on_off_noML):
        ...
        self.derivate_phi_fields_vgrids  = derivate_phi_fields_vgrids(super(), dgrid, ngrid)
        self.ngrid              = ngrid
    ...
    def make_dphi_fields_tau(self, phase_space, tau_long):
        ...
        self.derivate_phi_fields_vgrids.grids_fixed(phase_space)
        p_ngrids = self.derivate_phi_fields_vgrids.v_ngrids(phase_space)
        # p_ngrids.shape is [ nsamples, nparticle, ngrids * DIM ]
        ndphi_1 = self.derivate_phi_fields_vgrids.gen_derivative_phi_fields(phase_space)
