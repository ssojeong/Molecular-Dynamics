from src20211025.parameters.MD_parameters import MD_parameters
from src20211025.parameters.ML_fpw_parameters import ML_parameters
from phase_space                      import phase_space
from src20211025.utils.make_hamiltonian import make_hamiltonian
from src20211025.utils.system_logs import system_logs
from src20211025.utils.device import mydevice
from src20211025.integrator.linear_integrator import linear_integrator
from src20211025.HNN.data_loader import data_loader
from src20211025.HNN.data_loader import my_data
from src20211025.HNN.MD_learner import MD_learner
from src20211025.utils.check4particle_crash_dummy import check4particle_crash_dummy as crsh_chker
...
if __name__=='__main__':
    ...
    checkpoint_interval = ML_parameters.checkpoint_interval
    ...
    lr_thrsh = ML_parameters.lr_thrsh
    ...
    MD_learner = MD_learner(linear_integrator_obj, hamiltonian_obj, phase_space, opt, sch, loader, pothrsh, qp_weight,
                            Lambda, clip_value, lr_thrsh, system_logs, load_model_file)
    MD_learner.save_loss_distribution(ML_parameters.write_loss_filename)
