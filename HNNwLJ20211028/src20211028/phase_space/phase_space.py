...
class phase_space(pb):
    ...
    def __init__(self):
        ...
        assert(phase_space._obj_count <= 4), type(self).__name__ + ' has more than two objects'
    ...
    def set_l_list(self,_l_list):
        self._l_list = _l_list.clone()
