...
def main():
    ...
    data = {"train_file": '../data_sets/n16lt{}stpstraj24_s1000.pt'.format(tau_long),
            "valid_file": '../data_sets/n16lt{}stpstraj24_s100.pt'.format(tau_long),
            "test_file": '../data_sets/n16lt{}stpstraj24_s100.pt'.format(tau_long),
            "train_pts" : 100,
            "vald_pts"  : 10,
            "test_pts"  : 10,
    ...
    maindict = { "start_epoch"     : start_epoch,
                 "end_epoch"       : 10,
                 "save_dir"        : './results/traj_len08ws0{}tau{}ngrid{}{}_dpt{}'.format(window_sliding,traindict["tau_long"],ngrid,net_type,dpt_train+dpt_valid),
                 "tau_short"       : 1e-4,
