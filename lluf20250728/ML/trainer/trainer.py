...
from ML.LLUF.HexGrids import HexGrids
...
class trainer:
    ...
    def __init__(self,train_dict,loss_dict):
        ...
        if train_dict["ngrids"] > 1:
            print('create HexGrid object ....')
            grid_object = HexGrids(train_dict["b_list"],train_dict["a_list"])
        else:
            print('create SingleGrid object ....')
   ...
   # ==========================================================
    ...
    def net_builder(self,train_dict):
        ...
        input_dim    =  ngrids * (pw4mb_dim + output_dim) * factor # each of 6 grids, func of q (f1,f2), p (p1,p2)
