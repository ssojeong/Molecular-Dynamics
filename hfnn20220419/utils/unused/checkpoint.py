...
class checkpoint:
    ...
    """
    def __init__(self, net_list, mbpw, mbmm, opt = None, opt2 = None, sch = None):
        """
        ...
        #self._sch_reset = 'reset' # test
        #self.lr_reset = 0.001   # test
    ...
    def load_checkpoint(self, load_filename):
        ...
        if os.path.isfile(full_name):
            ...
            for net_id, nlist in enumerate(checkpoint['net_list']):
                ...
                # for param in self.net_list[net_id].state_dict():
                #    print(param, "\n", self.net_list[net_id].state_dict()[param])

            self.mbpw.load_state_dict(checkpoint['mbpw'])
            self.mbmm.load_state_dict(checkpoint['mbmm'])
