...
if __name__=='__main__':
    ...
    if crash_checker == 'yes':
        if crash_thrsh == 'yes':
            crsh_chker = check4particle_crash(rthrsh0, pthrsh0, rthrsh, pthrsh, crash_path)
        else :
    ...
    linear_integrator_dummy_obj = linear_integrator( MD_parameters.integrator_method, check4particle_crash_dummy(rthrsh0, pthrsh0, rthrsh, pthrsh, crash_path))

    hamiltonian_obj = make_hamiltonian(hamiltonian_type, linear_integrator_dummy_obj, tau_short, tau_long, ML_parameters)
        ...
        # use to prepare label, histogram about crash data
            ...
            if crash_history is False:
                ...
                if long_traj_save2file == 'yes':
                    ...
                    print('not save file .... large storage')
