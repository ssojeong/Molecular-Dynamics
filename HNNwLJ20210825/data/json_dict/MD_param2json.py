...
class MD_config:
    ...
    append_strike = 1000                                 # number of short steps to make one long step
    niter_tau_long  = 1                                 # number of MD steps for long tau
    save2file_strike = 1000                              # number of short steps to save to file; save2file_strike >= append_strike
...
if __name__=='__main__':
    ...
    crash_filename          = MD_data_dir + '/crash_info.pt'
    crash_path              = '../data/crash_dir/foldername/'
    crash_checker           = 'yes'
    ...
    data['crash_filename'] = crash_filename
    data['crash_path'] = crash_path
    data['crash_checker'] = crash_checker
    data['rthrsh'] = MD_config.rthrsh
    data['pthrsh'] = MD_config.pthrsh
