...
class ML_config:
    ...
    layer_list = [37,128,128,16,2]
    dropout_list = [0,0.2,0.2,0.2,0]
    activation = 'tanh'
...
if __name__=='__main__':
    ...
    #ML_chk_pt_filename = chk_pt_path + filename  # load models
    ...
    data['Lambda']                  = ML_config.Lambda
    data['clip_value']              = ML_config.clip_value
    ...
    data['layer_list']              = ML_config.layer_list
    data['dropout_list']            = ML_config.dropout_list
    data['activation']              = ML_config.activation
    data['dgrid']                   = ML_config.dgrid
    data['ngrid']                   = ML_config.ngrid
