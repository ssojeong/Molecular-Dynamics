...
if __name__=='__main__':
    ...
    loss_type        = ML_parameters.loss_type
    ...
    MD_learner = MD_learner(linear_integrator_obj, hamiltonian_obj, phase_space, opt, sch, loader, pothrsh, qp_weight, Lambda, clip_value, lr_thrsh, loss_type, system_logs, load_model_file)
    MD_learner.nepoch(ML_parameters.nepoch, ML_parameters.write_chk_pt_filename, ML_parameters.write_loss_filename, checkpoint_interval )
