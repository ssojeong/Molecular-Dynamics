...
# ===========================================================
class my_data:
    def __init__(self,train_filename,val_filename,test_filename,tau_long, n_chain,
                      tau_traj_len,train_pts=0,val_pts=0,test_pts=0):

        traj_len_index = round(tau_traj_len/tau_long)
        label_index = int((traj_len_index - 1) + n_chain)
        print('load my data ... traj len index', traj_len_index, 'n chain', n_chain, 'label index', label_index)
