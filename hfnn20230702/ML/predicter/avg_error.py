...
if __name__ == '__main__':
    #python avg_error.py > analysis/dqdp/log_n128rho0.6T0.7tau0.01_md
    ...
    maindict = {
        "traj_len": 8,
        "tau_long": 0.1,
        "everytau": 0.1,  # md,ml= 0.1 at tau=0.1 and 0.2 at tau=0.2
        "everysave": 0.1 # md = 0.1 at any tau
    }
    ...
    data = { "st_file" : '../../../data_sets/gen_by_MD/noML-metric-st1e-4every0.1t100/n{}rho{}T{}/'.format(npar,rho,T)
             ...
             #+ 'n{}rho{}T{}.pt'.format(npar,rho,T)
             'lt_file': '../../../data_sets/gen_by_ML/lt{}dpt1800000/n{}rho{}T{}/'.format(maindict["tau_long"],npar,rho,T)+"{}".format(states["name"])
             }
    ...
    # shape = [nsamples, (q,p,boxsize), trajectory, nparticles, DIM]
    print('qpl traj ref shape', qpl_traj_st.shape, 'window-sliding steps ', level, 'nsteps ', nstep, flush=True)
