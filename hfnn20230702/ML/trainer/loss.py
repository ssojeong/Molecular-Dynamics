...
class loss:
    ...
    # hk
    def __init__(self,poly_deg,rthrsh,ew,repw,repw2=0.01):
        ...
        print('loss initialized: rthrsh', rthrsh , 'pethrsh {:.3f}'.format(peth), 'e weight', ew, 'reg weight', repw, 'reg weight2', repw2)
    # =============================================================
    def eval(self,q_list, p_list, q_label, p_label, q_init, p_init, l_list):
        ...
        total = self.total_loss(qshape, pshape, eshape, mshape, rep, qrmse.item())
        # HK20220426
    ...
    #3.295383e-01     9.142127e+01
        ...
        # HK20220426 don't use it any more
    # def calculate_ew(self,qrmse_mean_value):
    #     if qrmse_mean_value>1.0: return 0.0
    #     if qrmse_mean_value>0.8: return 1e-10
    #     if qrmse_mean_value>0.6: return 1e-9
    #     if qrmse_mean_value>0.4: return 1e-7
    #     if qrmse_mean_value>0.3: return 1e-6
    #     if qrmse_mean_value>0.2: return 1e-5
    #     if qrmse_mean_value>0.1: return 1e-4
    #     if qrmse_mean_value>0.05: return 1e-1
    #     return 1.0  # HK
    # =============================================================
        # HK20220426
    def calculate_poly(self,qrmse_mean_value,prmse_mean_value):
        ...
        return 4
    # =============================================================
    def total_loss(self,qshape,pshape,eshape,mshape,rep,qrmse_mean_value):
