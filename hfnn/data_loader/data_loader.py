...
# ===========================================================
class my_data:
    def __init__(self,train_filename, val_filename, test_filename, num_in_chain=1, train_pts=0, val_pts=0, test_pts=0):

        self.train_set = torch_dataset(train_filename, num_in_chain)
        self.val_set   = torch_dataset(val_filename, num_in_chain)
        self.test_set  = torch_dataset(test_filename, num_in_chain)
