...
#from ML.networks.neural_net4    import neural_net4 as neural_net
from ML.networks.neural_net3     import neural_net3 as neural_net
...
class trainer:
    ...
    def __init__(self,train_dict,loss_dict):
        ...
        pwnet1 = mydevice.load(neural_net(pwnet_input,output_dim))
        pwnet2 = mydevice.load(neural_net(pwnet_input,output_dim))
        mbnet1 = mydevice.load(neural_net(mbnet_input,output_dim))
        mbnet2 = mydevice.load(neural_net(mbnet_input,output_dim))
    ...
    def verbose(self,e,mode):
        ...
        a = self.mbpwff.a()
        print('{} {:d} lr {:4e} weight on mbff {:4e} {:4e}'.format(mode,e,cur_lr,a[0],a[1]),flush=True)
        self.loss_obj.print(e,mode)
        self.loss_obj.clear()
