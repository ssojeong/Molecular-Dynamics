...
if __name__=='__main__':
    ...
    traindict = {"loadfile"     : None, # to load previously trained model
                 ...
                 "pwnet_nnodes" : 256,  # number of nodes in neural nets for force
                 "mbnet_nnodes" : 256,  # number of nodes in neural nets for momentum
                 "pw4mb_nnodes" : 32,   # number of nodes in neural nets for momentum
                 "grad_clip"    : 5,     # clamp the gradient for neural net parameters
                 ...
                 "tau_lr"       : 1e-3,  # starting learning rate
                 "sch_step"     : 1,     # defunct: scheduler step
                 "sch_decay"    : .999,  # 200 steps and reduce lr to 10%
                 "reset_lr"     : False} 
    ...
    lossdict = { "eweight" : 0.0,
                 "polynomial_degree" : 1 }

    data = { "train_file": '../data_sets/n16anyrholt10everystps_afew_nsamples30000train.pt',
