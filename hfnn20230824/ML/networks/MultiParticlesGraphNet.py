...
class MultiParticlesGraphNet(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, n_gnn_layers, act_fn=nn.GELU(), residual=False, attention=False):
        print('!!!!! multi par graph net ', input_dim, output_dim, n_gnn_layers)
