...
from data_loader.check_load_data import check_load_data # update !!
...
class torch_dataset(Dataset):
    ...
    def __init__(self, filename, label_idx):
        ...
        check_load = check_load_data(self.qp_list_input,self.qp_list_label,self.data_boxsize) # update !!
        check_load.check() # update !!
