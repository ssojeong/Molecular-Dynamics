...
class trainer:
    ...
    def __init__(self,train_dict,loss_dict):
        ...
        pwnet1 = mydevice.load(pw_net(pwnet_input,output_dim))
        pwnet2 = mydevice.load(pw_net(pwnet_input,output_dim))
        mbnet1 = mydevice.load(mb_net(mbnet_input,output_dim))
        mbnet2 = mydevice.load(mb_net(mbnet_input,output_dim))
    ...
    def scheduler_step(self):
        print('dont use scheduler step. . . quiting ')
        quit()
        self.sch.step()
    # ==========================================================
