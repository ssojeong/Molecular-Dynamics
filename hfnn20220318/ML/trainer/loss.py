...
class loss:
    ...
    def __init__(self,potential_function,eweight,poly_deg,eth=10):
    ...
    def eval(self,q_list, p_list, q_label, p_label, q_init, p_init, l_list):
        ...
        qrmse_val = self.q_RMSE_loss(q_list, q_label,l_list)
        qrmse = torch.sum(qrmse_val) / self.nsamples
